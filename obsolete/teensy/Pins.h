...
#define PIN_ODOMETER_FRONT_LEFT_SENSOR_A 22
#define PIN_ODOMETER_FRONT_LEFT_SENSOR_B 23

#define PIN_ODOMETER_FRONT_RIGHT_SENSOR_A 20
#define PIN_ODOMETER_FRONT_RIGHT_SENSOR_B 21
