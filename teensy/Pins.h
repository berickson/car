...
#define PIN_ODOMETER_FRONT_RIGHT_SENSOR_A 22
#define PIN_ODOMETER_FRONT_RIGHT_SENSOR_B 7

#define PIN_ODOMETER_BACK_LEFT_SENSOR_A 27
#define PIN_ODOMETER_BACK_LEFT_SENSOR_B 10
